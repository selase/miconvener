    ...
    return (
        <ConsoleLayout>
                        ...
                        <tbody>
                            {users.data.map((user) => (
                                <Tr
                                    ...
                                    selected={selectedUuid === user.uuid}
                                >
                                    <Td>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex gap-2">
                                    {/* Only what the server would allow: nobody edits or removes
                                        someone whose role reaches beyond their own. */}
                                    {selected.can_edit && (
                                        <Button
                                            onClick={() =>
                            ...
                            <div className="mt-6 space-y-5">
                                ...
                                <DetailCard title="Membership">
                                    ...
                                    <CopyField
                                        label="Last login"
                                        value={selected.last_login_at ?? 'Never'}
                                    />
            ...
            <ConfirmModal
                ...
                description={
                    removing &&
                    `Remove ${removing.name} from this organization? They will immediately lose access.`
                }
                confirmLabel="Remove"
                danger
            />
