    ...
    */
    ...
    'pages' => [
        ...
        'paths' => [
            ...
            // This app's page directory is `Pages`. Inertia's default is lowercase
            // `pages`, which a case-insensitive filesystem (macOS) accepts and a
            // case-sensitive one (Linux, as in CI) does not — every test asserting
            // a page component failed in CI while passing locally.
